...
- Security and GRC automation systems  
...
### Elite Metrics — Full-Stack BI Platform  
Enterprise KPI system replacing Excel workflows across 47+ locations.  
- Flask + PostgreSQL + Docker  
- Real-time BI integration (Power BI Direct Query)  
- Multi-tenant architecture with audit logging  

### Cyberhaven Triage — AI Security Automation  
AI-powered system for analyzing DLP incidents at scale.  
- AWS S3 + Gemini API + Streamlit  
- Automated triage of 60+ daily incidents  
- RAG-based feedback loop for continuous improvement  

### SICOM Data Miner — Python Automation Tool  
Desktop application for large-scale report processing.  
- Batch processing of 1,000+ files in minutes  
- Data validation and consolidation pipeline  
